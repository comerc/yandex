...
// что не нравиться в go? импорт без алиасов (как в TypeScript), таскание контекста первым аргументом в функциях, отсутствует интерполяция строк
...
// runtime.Gosched() - команда шедулеру
...
// guard clauses - "защитные оговорки", это когда в теле функции сначала проверяю условия и выхожу при их обнаружении, а только потом вычисляю основной вариант (вместо ветвления if-ов).
